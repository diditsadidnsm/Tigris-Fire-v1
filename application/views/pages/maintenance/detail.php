            ...
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('shop') ?>">Service</a></li>
                ...
                <div class="sermons-details-area">
                    ...
                    <div class="single-post-details-area">
                        <div class="post-content">
                            ...
                            <img class="mb-30" src="<?= base_url() ?>/images/service/<?= $rows->image ?>" alt="Layanan Tigris Fire Indonesia">
                            <div
                            ...
                            <h6>Rp <?= number_format($rows->price, 0, ',', '.') ?>,-</h6>
                                ...
                                <div class="comment-wrapper d-flex">
                                    <div class="comment-content">
                                        ...
                                        <form action="<?= base_url("/cart/add") ?>" method="POST">
                                            <input type="hidden" name="id_service" value="<?= $rows->id ?>">
